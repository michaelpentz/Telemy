...
Management ports (TCP 3000, 8090) are restricted to the control plane IP (`<redacted-ec2-ip>/32`). UDP ports are open to all sources since IRL Pro connections come from dynamic cellular IPs.
