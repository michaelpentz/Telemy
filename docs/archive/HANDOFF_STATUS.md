# Handoff Status (Index / Compatibility Stub)

This file was reduced to an index to keep the archive easier to navigate.

## Use These Files Instead

- Current status summary: `docs/CURRENT_STATUS.md`
- Full historical handoff log and addenda: `docs/archive/HANDOFF_HISTORY.md`
...
- Canonical contracts/specs remain in `docs/`.
- Add new dated handoff entries to `docs/archive/HANDOFF_HISTORY.md`.
- Update `docs/CURRENT_STATUS.md` when priorities or validated runtime state changes.
- If a handoff entry references repo-root dock bridge files (`aegis-dock-bridge.js`), verify they exist in the current checkout before treating that work as present.
