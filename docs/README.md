> **ARCHIVED:** These docs describe the v0.0.3 architecture (Rust bridge + C++ plugin via IPC named pipes). This architecture was eliminated in v0.0.4. Retained for historical reference. See `telemy-v0.0.4/` for current architecture.
