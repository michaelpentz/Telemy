> **ARCHIVED:** The IPC named pipe protocol was eliminated in v0.0.4. The all-native C++ plugin communicates directly via OBS C APIs and CEF JS injection. Retained for historical reference.
